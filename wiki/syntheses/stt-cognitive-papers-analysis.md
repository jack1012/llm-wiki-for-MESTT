---
title: "Cognitive Dimension of STT: A Systematic Analysis of 20 Papers"
aliases: [STT認知面向論文分析, Cognitive Papers in STT]
type: synthesis
tags: [STT, Cognitive, Concept_Image, Three_Worlds, AMT, Task_Design, Prerequisites, Meta_Analysis]
sources: [summary-1994-crawford-conceptions, summary-1998-tall-difficulties, summary-1998-tall-patterns, summary-2008-gruenwald-reducing-gap, summary-2011-duah-objects, summary-2013-tall-thinking, summary-2013-winslow-structuralist, summary-2013-gueudet-ems-newsletter, summary-2014-zakaria-hierarchical, summary-2009-artigue-bosch-networking, summary-2019-schueler-meyer-interest, summary-2020-haso-srl, summary-2021-breen-tasks, summary-2021-job-relating, summary-2022-pinto-activity, summary-2023-geisler-tasks, summary-2023-liebendoerfer-knowledge, summary-2023-pinto-tasks, summary-2023-rach-prerequisites, summary-2024-mangarin-difficulties-review]
last_updated: 2026-04-18
---

# Cognitive Dimension of STT: A Systematic Analysis of 20 Papers

> 本頁面對知識庫中 76 篇 source 論文進行系統性篩選，識別出 20 篇以認知為核心或顯著主題的論文，按五個子群分類分析，並追蹤認知研究從 1994 年至 2024 年的四階段演化。

---

## 子群 A：認知斷裂的診斷——「學生的心智發生了什麼？」（6 篇）

這是 STT 研究中最早的一批論文，奠定了整個領域的認知基礎。
...
這六篇論文共同建構了一套**認知診斷工具箱**：

```
Crawford (1994): 學生帶入的數學觀（表面 vs 深層）
        ↓
Tall (1998a): 概念意象 ≠ 概念定義 → 學生「以為懂了」
        ↓
Tall (1998b): 這種落差形成系統性的誤解模式
        ↓
Zakaria (2014): 低層缺口 → 高層崩塌（連鎖反應）
        ↓
Duah (2011): 必須完成從「動詞」到「名詞」的心智轉變
        ↓
Tall (2013): 完整框架——從三個世界到 Met-befores
```

**核心洞見**：認知斷裂不是「學更多就好」的量變問題，而是「重新定義什麼算作理解」的**質變**。[[Advanced Mathematical Thinking]] 要求的不只是更強的計算力，而是完全不同的思維模式。

---

## 子群 B：制度性認知分析——「知識在體制中如何被組織？」（4 篇）

這些論文從認知出發，但將視角擴展到**制度結構如何塑造認知**。
...
這四篇論文標誌了**從「怪學生」到「怪制度」的認知視角轉向**：

> [[summary-2008-gruenwald-reducing-gap]]: Students rely too much on algorithmic procedures and lack the ability to use formal language or conduct proofs.

> 但 [[summary-2013-winslow-structuralist|Winslow (2013)]] 追問：**為什麼**學生會如此依賴算法？——因為中學的制度結構就是這樣組織知識的。

---

## 子群 C：任務設計與認知橋接——「什麼樣的任務能觸發認知轉變？」（5 篇）
...
這五篇論文將認知研究從**診斷**推向**教學設計**：

> 不只問「學生哪裡不懂」，而是問「什麼樣的學習活動能讓他們經歷認知轉變？」

四個設計原則：
1. **非常規性**：任務不能套公式解決（[[Non-routine Tasks]]）
2. **反思性**：要求學生解釋「為什麼」，不只是「怎麼做」
3. **連結性**：讓學生看見中學知識與大學知識之間的有機關係（[[Revisiting School Mathematics]]）
4. **建構性**：讓學生親自參與定義的建構過程，而非被動接受

---

## 子群 D：先備知識與認知預測——「什麼認知準備能預測成功？」（3 篇）
...
答案不是「中學成績多高」，而是：
1. **概念理解的深度** > 程序操作的熟練度
2. **[[Formal-deductive Readiness|形式演繹推理的準備度]]** > 計算速度
3. **後設認知能力**（知道自己不懂什麼、如何調整學習策略）> 投入時間

---

## 子群 E：綜合性回顧——「認知研究的位置在哪？」（2 篇）
...
```
階段 1 (1994-1998)          階段 2 (2003-2013)
診斷認知障礙               制度性認知分析
Crawford, Tall              Gruenwald, Winslow,
                            Gueudet, Tall (2013)
     │                           │
     ▼                           ▼
階段 3 (2019-2023)          階段 4 (2020-2024)
任務設計與教學橋接          預測與整合
Breen, Pinto, Geisler,     Rach, Liebendörfer,
Schüler-Meyer               Haso, Mangarin
```

### 階段 1 → 2 的轉向：從「學生的問題」到「知識組織的問題」

- 階段 1 認為：「學生的概念意象有問題，需要矯正」
- 階段 2 發現：「中學的知識組織方式**系統性地**生產了這些『有問題』的概念意象」

### 階段 2 → 3 的轉向：從「問題診斷」到「教學行動」

- 階段 2 認為：「我們已經知道問題在哪，但改革在制度中無法存活」
- 階段 3 回應：「那就設計能在現有制度內運作的微觀教學工具」（非常規任務、定義活動、重訪中學數學）

### 階段 3 → 4 的轉向：從「單一維度」到「多維整合」

- 階段 3 認為：「好的任務設計就能觸發認知轉變」
- 階段 4 發現：「認知準備不只是知識量的問題，還包括後設認知能力；而且認知與情意是[[Affective-Cognitive Entanglement|糾纏]]的」
...
- [[stt-problematics-systematic-analysis]] — 認知論文主要對應 **P1 認知斷裂** 問題意識群
- [[stt-synonyms-semantic-analysis]] — 認知研究偏好使用 **gap**（鴻溝）與 **discontinuity**（斷裂）隱喻
- [[stt-research-orientations-development]] — 認知取向是「第一波」研究的核心，其局限催生了制度取向與情意取向
- [[definition-of-stt]] — 認知層面是 STT 三層定義中的「第一層：認識論的躍遷」
- [[cards-thematic-map-and-causal-chains]] — 對應主題群 A（認知斷層與概念理解，~13 張卡片）

---

## 📝 創建與編修紀錄

- **2026-04-18**: 根據用戶 /query「列出所有跟認知有關的論文，並分析」，系統性篩選 20 篇認知相關論文，分為五個子群（A 認知診斷、B 制度性認知分析、C 任務設計、D 先備知識預測、E 綜合回顧），分析認知研究的四階段演化。
